...
var DBHelper = {
    ...
    openDatabase : function () {
        this.db = SQLite.openDatabase("FormComposerData18.db", "1.0", "Test Database", 200000, this.openCB, this.errorCB);
    },
    ...
    insertForm: function(tx, formName, callback){
        tx.executeSql('INSERT INTO Forms(name, numberIntances) VALUES (?, ?)', [formName, 1], callback);
    },
    ...
    updateFormNumberInstances : function(tx, numberInstances, id, callback) {
        tx.executeSql('UPDATE Forms SET numberIntances = ? WHERE id = ?', [instances, id], callback);
    },
